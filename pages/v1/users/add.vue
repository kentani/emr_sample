  ...
  methods: {
    ...
    onClickBackBtn(page) {
      if(page === 'training-history') {
        this.$router.push('/v1/users/add/personal-data');
      } else if(page === 'weight-history') {
        this.$router.push('/v1/users/add/training-history');
      } else if(page === 'image-history') {
        this.$router.push('/v1/users/add/weight-history');
      };
    },
    onClickNextBtn(page) {
      if(page === 'personal-data') {
        ...
        this.$router.push('/v1/users/add/image-history');
      } else if(page === 'image-history') {
        ;
      };
    }
